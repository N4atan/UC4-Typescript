...
function menuApp() {
    while (true) {
        ...
        let userOption = ask.question('Qual?').toUpperCase()

        if (userOption == 'Q1') { question1(); console.clear() }
        else if (userOption == 'Q2') { question2(); console.clear() }
        else if (userOption == 'Q3') { question3(); console.clear() }
        else if(userOption == 'Q4') {question4(); console.clear()}
    }
}
